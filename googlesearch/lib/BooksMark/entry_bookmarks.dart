...
import 'package:googlesearch/BooksMark/teen_bookmarks_screen.dart';

import 'package:lottie/lottie.dart';
import 'package:speech_to_text/speech_to_text.dart';

class EntryBookmarks extends StatefulWidget {
  const EntryBookmarks ({super.key});

  @override
  State<EntryBookmarks > createState() => _EntryHistoryState();
}

class _EntryHistoryState extends State<EntryBookmarks > {
...
Future.delayed(Duration(seconds: 4), () {
  ...
  void _navigateBasedOnAge() {
    if (_ageCategory.toLowerCase() == 'fifties'|| _ageCategory.toLowerCase()== "twenties") {
      Navigator.push(context, MaterialPageRoute(builder: (_) => TeenBookmarksScreen()));
    } else {
